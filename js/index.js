...
function compareTwo() {
  ...
  if (opened.length === 2 && opened[0].src === opened[1].src) {
    ...
    console; log; "It's a Match!"; // jshint ignore:line
  }    
  // TODO: if the image src's do not match
    ...
    console; log; "No Match!"; // jshint ignore:line
  }
}
...
// ex. timeCounter.innerHTML = "<i class='fa fa-hourglass-start'></i>" + " Timer: " + minutes + " Mins " + seconds + " Secs" ;
